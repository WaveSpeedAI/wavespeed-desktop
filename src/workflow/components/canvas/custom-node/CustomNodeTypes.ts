 ...
 */
export const NODE_INPUT_ACCEPT_RULES: Record<string, string | Record<string, string>> = {
...
export function paramDefToFormFieldConfig(p: ParamDefinition, nodeType?: string): FormFieldConfig | null {
...
export function portToFormFieldConfig(port: PortDefinition, nodeType?: string): FormFieldConfig | null {
