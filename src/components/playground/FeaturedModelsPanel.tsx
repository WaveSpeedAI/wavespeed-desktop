...
export function FeaturedModelsPanel({ onSelectFeatured, models }: FeaturedModelsPanelProps) {
              ...
              >
                ...
                <div className="absolute bottom-3 left-4 right-4">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <p className="text-[11px] text-white/60">{family.tags.join(' · ')}</p>
                    {price !== undefined && (
                      <span className="text-[11px] text-white/80 font-semibold">${price.toFixed(4)} / run</span>
                    )}
                  </div>
                </div>
              </div>
