...
const FEATURED_MODEL_FAMILIES = [
  ...
  },
  {
    ...
    variants: [
      ...
      {
        id: "bytedance/seedance-v1.5-pro/video-extend-fast",
        type: "video-extend",
      },
    ],
  ...
  },
  {
    ...
    variants: [{ id: "wavespeed-ai/wan-2.2/animate", type: "motion-control" }],
  ...
  },
  {
    ...
    variants: [
      ...
      {
        id: "wavespeed-ai/infinitetalk-fast/video-to-video",
        type: "digital-human",
      },
    ],
  ...
  },
  {
    ...
    variants: [
      ...
      {
        id: "google/nano-banana-pro/text-to-image-multi",
        type: "text-to-image",
      },
      ...
      <div className="page-header px-4 md:px-6 py-4 relative z-10">
        <div className="flex flex-col gap-1.5 md:flex-row md:items-baseline md:gap-3">
          ...
          <p className="text-muted-foreground text-xs md:text-sm">
            {t("welcome.featuredModels.description")}
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-auto px-6 py-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-5xl mx-auto">
          {FEATURED_MODEL_FAMILIES.map((family) => {
            ...
            const uniqueTypes = [
              ...new Set(family.variants.map((v) => v.type)),
            ];
            ...
            return (
              <div
                ...
                onClick={() => {
                  const smartFamily = SMART_FORM_FAMILIES.find(
                    (sf) => sf.primaryVariant === family.primaryVariant,
                  );
                  if (smartFamily) {
              ...
              >
                ...
                <div className="relative aspect-[3/4] overflow-hidden bg-muted">
                  ...
                  <div className="absolute bottom-2 left-3 right-3 flex items-end justify-between">
                    ...
                    <Badge
                      variant="secondary"
                      className="shrink-0 text-[10px] px-1.5 py-0 font-medium bg-black/40 text-white border-0"
                    >
