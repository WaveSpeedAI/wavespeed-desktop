...
import { backgroundRemoverDef, BackgroundRemoverHandler } from './background-remover'
...
export function registerFreeToolNodes(): void {
  ...
  for (const spec of FREE_TOOL_SPECS) {
    ...
    nodeRegistry.register(definition, new UnsupportedFreeToolHandler(definition))
  }
}
