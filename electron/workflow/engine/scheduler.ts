 ...
 */
interface SimpleEdge { sourceNodeId: string; targetNodeId: string }

export function topologicalLevels(nodeIds: string[], edges: SimpleEdge[]): string[][] {
...
export function downstreamNodes(startNodeId: string, nodeIds: string[], edges: SimpleEdge[]): string[] {
  const adj = new Map<string, string[]>()
