...
import { CameraCapture } from '@/components/playground/CameraCapture'
import { VideoRecorder } from '@/components/playground/VideoRecorder'
import { AudioRecorder } from '@/components/playground/AudioRecorder'
          ...
          {urls.map((url, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Mobile: always show delete button with confirmation */}
                <Button
                  variant="destructive"
                  size="icon"
